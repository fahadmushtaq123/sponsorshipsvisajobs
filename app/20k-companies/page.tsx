...
export const metadata: Metadata = {
  title: 'Explore 10,000+ Companies | Your Job Board',
  description: 'Browse through a curated list of over 10,000 companies. Find your next employer and explore job opportunities.',
...
export default async function TwentyKCompaniesPage() {
  const filePath = path.join(process.cwd(), 'companies_list_10000.json');
  const fileContents = await fs.readFile(filePath, 'utf8');
  const companies: Company[] = JSON.parse(fileContents);

  return (
    <div style={{ padding: '40px', textAlign: 'center', backgroundColor: '#f3f4f6' }}>
      <h1 style={{ fontSize: '3rem', color: '#111827', marginBottom: '10px' }}>Explore Over 10,000 Companies</h1>
